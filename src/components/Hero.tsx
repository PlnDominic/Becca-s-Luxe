  ...
  return (
    <section id="home" className="pt-24 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="relative h-[420px] sm:h-[480px] rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-luxe-rose via-luxe-mauve to-luxe-lavender flex items-center justify-center">
